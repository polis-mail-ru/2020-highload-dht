...
```
Сравнение результатов испытаний в режиме симулирования запросов на чтение даёт основания для выводов, диаметрально противоположных заявленным в предыдущем разделе. Несмотря на аналогично двукратное падение интенсивности операций над запросами, в текущей конфигурации кластера достигается почти равнозначное (~49%) уменьшение средней задержки и значительно превосходящее первоначальное шардирование улучшение времён отклика. Необходимо отметить, что подобная динамика проявляется на всех охватываемых тестами уровнях распределения и характеризуется прогрессивной коррекцией дельты по мере приближения к максимальной оценке времени ожидания (от 44% для 75% до 70%-го прироста быстродействия в случае с наибольшей задержкой обслуживания).<br/>                  
<ins>Flamegraph-анализ</ins><br/>  
