...
Несмотря на отсутствие очевидных факторов динамики в структуре профилей, в качестве её предпосылок можно предположить сокращение накладных расходов в виде текущих flush-операций на уровне экземпляра LSM-хранилища <em>RocksDB</em>.     
