...
- демонстрация и оценка корреляций сервера относительно нагрузки непосредственно во время сеанса;<br/>    
...
1) По собственной невнимательности или ввиду фактического отсутствия в документации автором не были найдены указания (рекомендации) по размещению в локальной системе программных файлов генерации запросов (патронов), а также любые сведения, относящиеся к созданию таких программ. У пользователей, лишь приступающих к работе с инструментом и не имеющих доступа к [записи](https://ok.ru/live/1901433396913) на сайте Технополиса либо альтернативным ресурсам, неминуемо возникает потребность в разъяснении данного аспекта подготовки или, как минимум, упоминании о нём в официальном руководстве (при этом следует предположить, что часть подобных проблем допускает решение в рамках [онлайн-конференции](https://gitter.im/yandex/yandex-tank) с участием разрабочиков, но её формат заведомо ориентирован на обмен информацией между профессиональными инженерами по тестированию, а не на консультирование абсолютных новичков);<br/>
