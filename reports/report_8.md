...
Рис. 5 - Результаты профилирования наличия/отсутствия блокировок при нагрузке сервера (реализация сервера на One-Nio)
...
входящие запросы, что даёт задуматься над оптимизацией самой реализацией. Кроме того, это говорит о том, что требуется
проводить более тонкую настройку сервера и самого pipeline, в котором производится добавление батареек для обработки и
работы с входящими запросами.