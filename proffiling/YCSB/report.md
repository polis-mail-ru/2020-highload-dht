...
3. Для выполнения нагрузки были сделаны 2 trace файла, первый - [trace_rest](workloads/trace_rest.txt)содержит 1 миллион ключей,
   второй - [trace_rest_range](workloads/trace_rest_range.txt) содержит диапазоны ключей используемы для нагрузки range запросов.
