...
дольше на 30% классического подхода. Но стоит отдать должное и если долго прогревать сервис, то результаты
...
Также вместо стандартного алгоритма хеширования был взять более быстрый и равномерный алгоритм murmurhash.
...
все потоки одинаковых размеров, а значит мы не имеем доминирующих и голодающих потоков.
 ...
 последние три процентиля 100, 99.99, 99.9 не так уж и спольно друг от друга отключаются, что безусловно
 хороший показатель.
