...
максимальной задержки ниже 100мс (чем меньше тем лучше). Мы должны помнить, что скорость работы
сервиса и его способность обрабатывать большое количество запросов в секунду на самом деле связаны
но не эквивалентны.
