...
public class CustomServerAsync extends HttpServer {

    private final DAO dao;
    private final ExecutorService executorService =
            Executors.newFixedThreadPool(Runtime.getRuntime().availableProcessors());

    public CustomServerAsync(final DAO dao,
    ...
    private void getInternal(String idParam, HttpSession session) throws IOException {
    ...
    private void putInternal(final String idParam, final Request request, final HttpSession session) throws IOException {
        Response responseHttp;
        if (idParam == null || idParam.isEmpty()) {
            responseHttp = new Response(Response.BAD_REQUEST);
            responseHttp.addHeader(HttpHeaders.CONTENT_LENGTH + ": " + 0);
    ...
    private void deleteInternal(String idParam, HttpSession session) throws IOException {
        Response responseHttp;
