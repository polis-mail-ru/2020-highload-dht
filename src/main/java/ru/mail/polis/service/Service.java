 ...
 * <li>{@code GET /v0/entities?start=<ID>[&end=<ID>]} -- get range of data between {@code from} (inclusive) and optional {@code to} (exclusive). Returns {@code 200} and HTTP chunked response with {@code <key>\n<value>} chunks.</li>
