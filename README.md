...
```
Согласно выходным данным текущей серии, для получения результата обработки 99,99% запросов, созданных с использованием <em>wrk</em> понадобилось около 43 нс, в то время как длительность ожидания оставшихся оказалась почти на 11 нс больше. В среднем задержка ответа составила приблизительно 2 нс при стандартном отклонении на уровне 92%.           
...
<p align="center">Рис.9. Flamegraph выделения RAM в рамках симуляции PUT-запросов</p>
