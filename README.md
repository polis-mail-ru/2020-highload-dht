...
### 3) <em>(PUT /v0/entity?id=<ID></em>) &nbsp; wrk -t1 -c1 -d5m -s src/profiling/wrk_scripts/get.lua -R2000 --latency http://127.0.0.1:8080/<br/>
...
### 4) <em>(PUT /v0/entity?id=<ID></em>) &nbsp; wrk -t1 -c1 -d5m -s src/profiling/wrk_scripts/delete.lua -R2000 --latency http://127.0.0.1:8080/<br/>
